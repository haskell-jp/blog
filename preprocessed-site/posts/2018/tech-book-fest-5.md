...
来たる10月8日（月・祝）に池袋にて技術系同人誌即売会「技術書典 5」が開催されます。

Haskell題材にした同人誌もいくつかあるようですのでまとめてみました。

# 技術書典とは？

![技術書典 5 バナー](../../img/2018/tech-book-fest-5-banner.png)

（バナー画像は技術書典 5 サイトよりの引用です。）
...
事前準備の重要性が高まった今回、Haskeller向けにHaskellサークルをまとめようと思いました。

# か14 — Dodgson Labs

## いきなり Haskell 〜もう挫折しないための12講〜（仮）
...
> Haskell での手続きプログラミングの側面について解説します。
>
> 対象読者
> - Haskell入門書程度が読める
...
## Haskell で作る Web アプリケーション — 遠回りして学ぶ Yesod 入門
